...
import it.polimi.nsds.kafka.BackEnd.OldServices.OldCourseService;
import it.polimi.nsds.kafka.BackEnd.OldServices.OldProjectService;
import it.polimi.nsds.kafka.BackEnd.OldServices.OldRegistrationService;
import it.polimi.nsds.kafka.BackEnd.OldServices.OldUserService;
...
public class Connection implements Runnable{
    ...
    private final OldCourseService courseService;
    private final OldProjectService projectService;
    private final OldRegistrationService registrationService;

    private boolean isActive = true;

    public Connection(Socket socket, OldUserService userService, OldCourseService courseService,
                      OldProjectService projectService, OldRegistrationService registrationService){
        this.socket = socket;
