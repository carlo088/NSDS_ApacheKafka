...
public class UserServiceMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ServerSocket serverSocket = new ServerSocket(ConfigUtils.userServicePort);
        ...
        System.out.println("UserService listening on port: " + ConfigUtils.userServicePort);
        while(true){
            try {
                // accept a socket and run a thread for that client connection
                Socket socket = serverSocket.accept();
                UserService userService = new UserService(socket, db_users, db_courses);
