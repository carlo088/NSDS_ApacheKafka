...
public class RegistrationConsumer extends Thread{
    ...
    public void run(){
        ...
        final KafkaConsumer<String, String> registrationConsumer = setRegistrationConsumer();
        registrationConsumer.subscribe(Collections.singleton("courses"));

        while (true){
            final ConsumerRecords<String, String> courseRecords = registrationConsumer.poll(Duration.of(1, ChronoUnit.MINUTES));
    ...
    private static KafkaConsumer<String, String> setRegistrationConsumer(){
        ...
        consumerProps.put(ConsumerConfig.GROUP_ID_CONFIG, "registrationCoursesGroup");
